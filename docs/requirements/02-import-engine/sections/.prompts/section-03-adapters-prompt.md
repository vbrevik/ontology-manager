...
Generate content for section `section-03-adapters` (filename: `section-03-adapters.md`).
...
for `section-03-adapters` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/ontology-manager/docs/requirements/02-import-engine/sections/section-03-adapters.md`
