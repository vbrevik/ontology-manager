...
Generate content for section `section-04-service` (filename: `section-04-service.md`).
...
for `section-04-service` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/ontology-manager/docs/requirements/02-import-engine/sections/section-04-service.md`
