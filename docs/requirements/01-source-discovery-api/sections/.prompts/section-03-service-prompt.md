...
Generate content for section `section-03-service` (filename: `section-03-service.md`).
...
for `section-03-service` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/ontology-manager/docs/requirements/01-source-discovery-api/sections/section-03-service.md`
