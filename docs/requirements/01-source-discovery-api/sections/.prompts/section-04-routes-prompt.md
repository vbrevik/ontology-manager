...
Generate content for section `section-04-routes` (filename: `section-04-routes.md`).
...
for `section-04-routes` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/ontology-manager/docs/requirements/01-source-discovery-api/sections/section-04-routes.md`
