...
Generate content for section `section-06-tests` (filename: `section-06-tests.md`).
...
for `section-06-tests` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/ontology-manager/docs/requirements/01-source-discovery-api/sections/section-06-tests.md`
