...
Generate content for section `section-08-state-persistence` (filename: `section-08-state-persistence.md`).
...
for `section-08-state-persistence` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/ontology-manager/docs/requirements/03-ontology-browser/sections/section-08-state-persistence.md`
