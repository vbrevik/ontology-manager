...
Generate content for section `section-02-data-layer` (filename: `section-02-data-layer.md`).
...
for `section-02-data-layer` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/ontology-manager/docs/requirements/03-ontology-browser/sections/section-02-data-layer.md`
