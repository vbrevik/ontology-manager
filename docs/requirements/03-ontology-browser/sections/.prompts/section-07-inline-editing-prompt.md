...
Generate content for section `section-07-inline-editing` (filename: `section-07-inline-editing.md`).
...
for `section-07-inline-editing` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/ontology-manager/docs/requirements/03-ontology-browser/sections/section-07-inline-editing.md`
