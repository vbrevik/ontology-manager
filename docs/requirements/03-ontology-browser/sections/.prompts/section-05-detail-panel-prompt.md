...
Generate content for section `section-05-detail-panel` (filename: `section-05-detail-panel.md`).
...
for `section-05-detail-panel` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/ontology-manager/docs/requirements/03-ontology-browser/sections/section-05-detail-panel.md`
