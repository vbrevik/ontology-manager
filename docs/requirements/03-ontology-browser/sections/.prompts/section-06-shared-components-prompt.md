...
Generate content for section `section-06-shared-components` (filename: `section-06-shared-components.md`).
...
for `section-06-shared-components` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/ontology-manager/docs/requirements/03-ontology-browser/sections/section-06-shared-components.md`
