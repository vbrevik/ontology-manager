...
Generate content for section `section-01-infrastructure` (filename: `section-01-infrastructure.md`).
...
for `section-01-infrastructure` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/ontology-manager/docs/requirements/03-ontology-browser/sections/section-01-infrastructure.md`
