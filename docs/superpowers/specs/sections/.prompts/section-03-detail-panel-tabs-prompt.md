...
Generate content for section `section-03-detail-panel-tabs` (filename: `section-03-detail-panel-tabs.md`).
...
for `section-03-detail-panel-tabs` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/ontology-manager/docs/superpowers/specs/sections/section-03-detail-panel-tabs.md`
