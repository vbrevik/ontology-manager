...
Generate content for section `section-04-testing` (filename: `section-04-testing.md`).
...
for `section-04-testing` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/ontology-manager/docs/superpowers/specs/sections/section-04-testing.md`
