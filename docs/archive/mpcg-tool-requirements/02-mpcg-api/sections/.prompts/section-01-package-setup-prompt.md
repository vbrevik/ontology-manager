...
Generate content for section `section-01-package-setup` (filename: `section-01-package-setup.md`).
...
for `section-01-package-setup` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/multi-perspective-context-ontology/docs/requirements/02-mpcg-api/sections/section-01-package-setup.md`
