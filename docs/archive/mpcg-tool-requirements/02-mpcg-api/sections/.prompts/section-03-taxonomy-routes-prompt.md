...
Generate content for section `section-03-taxonomy-routes` (filename: `section-03-taxonomy-routes.md`).
...
for `section-03-taxonomy-routes` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/multi-perspective-context-ontology/docs/requirements/02-mpcg-api/sections/section-03-taxonomy-routes.md`
