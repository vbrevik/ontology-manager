...
Generate content for section `section-07-constraint-routes` (filename: `section-07-constraint-routes.md`).
...
2. `/Users/vidarbrevik/projects/multi-perspective-context-ontology/docs/requirements/02-mpcg-api/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/vidarbrevik/projects/multi-perspective-context-ontology/docs/requirements/02-mpcg-api/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-07-constraint-routes` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/multi-perspective-context-ontology/docs/requirements/02-mpcg-api/sections/section-07-constraint-routes.md`
