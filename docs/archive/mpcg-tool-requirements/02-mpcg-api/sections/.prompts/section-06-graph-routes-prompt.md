...
Generate content for section `section-06-graph-routes` (filename: `section-06-graph-routes.md`).
...
for `section-06-graph-routes` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/multi-perspective-context-ontology/docs/requirements/02-mpcg-api/sections/section-06-graph-routes.md`
