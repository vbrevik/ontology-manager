...
Generate content for section `section-01-workspace-foundation` (filename: `section-01-workspace-foundation.md`).
...
for `section-01-workspace-foundation` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/universal-context-model/docs/requirements/01-mpcg-package/sections/section-01-workspace-foundation.md`
