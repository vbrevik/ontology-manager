...
Generate content for section `section-08-integration-verification` (filename: `section-08-integration-verification.md`).
...
for `section-08-integration-verification` to understand what this section should contain.
...
`/Users/vidarbrevik/projects/universal-context-model/docs/requirements/01-mpcg-package/sections/section-08-integration-verification.md`
